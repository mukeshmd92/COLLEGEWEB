  ...
  return (
    <Element className='hero Container'  name='hero'>
        <div className="hero-text">
            ...
            <p>Our Cuttng-edge  maintenance is deigned to empower students with the knowage skkills and eperience needed to excel in the dynamic field of education</p>
